...
\vspace{-8pt}
\resumeItemListStart
\resumeItem{Implemented and benchmarked statistical models (Seasonal AR, VAR, Facebook Prophet) and deep learning based models (LSTM, TCN) for demand data across different nodes in pharmaceutical supply chains, achieving a \textbf{90\% reduction in Mean Absolute Percentage Error}.}
\vspace{-3pt}
